// Modified from https://github.com/BretStateham/28BYJ-48/tree/master/Arduino/Code/S07-AccelStepperDemo
...
int currentPosition = 2048;  //4096 steps per rotation when half stepping
...
void loop() {
  ...
  if(stepper1.distanceToGo() == 0 && isDataAvailable){
     if(clockwise == true){
      ...
      stepper1.moveTo(currentPosition);  //Go to the target position
    }
  }
